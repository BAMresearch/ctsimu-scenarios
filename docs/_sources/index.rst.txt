...
| A |link-pre|\ |release|\ |link-post| of this specification is available. Example scenarios and simulated projection images can be found on the specification's `Github repository <https://github.com/BAMresearch/ctsimu-scenarios>`__.
